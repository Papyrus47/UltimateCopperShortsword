...
namespace UltimateCopperShortsword.NPCs.BossB
{
    ...
    public class UltimateCopperAxe : FSMnpc
    {
        ...
        public override string BossHeadTexture => "Terraria/Item_" + ItemID.CopperAxe;
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Ultimate Copper Axe");
            DisplayName.AddTranslation(GameCulture.Chinese, "最终铜斧");
        }
        ...
        public override void AI()
        {
            ...
            if(Time1 % 10 == Main.rand.Next(10) && Main.netMode != 1)
            {
                for (int i = -1; i <= 1; i++)
                {
                    float r = npc.rotation + i * MathHelper.Pi / 32;
                    Projectile.NewProjectile(npc.Center, r.ToRotationVector2() * 10,
